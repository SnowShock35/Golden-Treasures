package uk.snowshock35.goldentreasures.entity;
...
public class EntityGoldenBomb extends EntityThrowable {

    int count = 0;
    public EntityPlayer playerThrower;

    public EntityGoldenBomb(World par1World) {
        super(par1World);
    }

    public EntityGoldenBomb(World par1World, EntityPlayer par2EntityPlayer) {
        super(par1World, par2EntityPlayer);
        playerThrower = par2EntityPlayer;
    }

    @SideOnly(Side.CLIENT)
    public EntityGoldenBomb(World par1World, double par2, double par4, double par6, int par8) {
        this(par1World, par2, par4, par6);
    }

    public EntityGoldenBomb(World par1World, double par2, double par4, double par6) {
