...
import uk.snowshock35.goldentreasures.utils.EntityHelper;
...
import static uk.snowshock35.goldentreasures.references.ReferencesConfigInfo.*;
...
public class ConfigHandler {
    ...
    private static void loadGoldenFeatherSettings() {
        final String category = ReferencesConfigInfo.ConfigCategories.GOLDEN_FEATHER;
        LOGGER.debug("Loading configuration category [{}]", category);
        configuration.setCategoryRequiresMcRestart(category, true);
        configuration.setCategoryComment(category, ReferencesConfigInfo.ConfigCategories.GOLDEN_FEATHER_COMMENT);
