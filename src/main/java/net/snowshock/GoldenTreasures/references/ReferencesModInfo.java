...
public class ReferencesModInfo {
    ...
    public static final String CLIENT_PROXY_PATH = "net.snowshock.GoldenTreasures.ClientProxy";
    public static final String SERVER_PROXY_PATH = "net.snowshock.GoldenTreasures.CommonProxy";
}
