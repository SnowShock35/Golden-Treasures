...
public class ItemGoldenLilypad extends ItemBlock {
    public ItemGoldenLilypad(Block block) {
        super(block);
        this.setUnlocalizedName(ReferencesModItems.GOLDEN_LILYPAD);
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float posX, float posY, float posZ) {
        ...
        if (var4 != null && var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (world.canMineBlock(player, var5, var6, var7) && player.canPlayerEdit(var5, var6, var7, var4.sideHit, stack)
                ...
                world.setBlock(var5, var6 + 1, var7, Block.getBlockFromName(ReferencesModBlocks.GOLDEN_LILYPAD));
                world.scheduleBlockUpdate(var5, var6 + 1, var7, Block.getBlockFromName(ReferencesModBlocks.GOLDEN_LILYPAD), (int) (1360F * ((float) getDelayInSeconds() / 100F)));
        ...
        if (var4 == null)
            ...
            if (var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (world.getBlock(var5, var6, var7).getMaterial() == Material.water && world.getBlockMetadata(var5, var6, var7) == 0 && world.isAirBlock(var5, var6 + 1, var7)) {
                    world.setBlock(var5, var6 + 1, var7, Block.getBlockFromName(ReferencesModBlocks.GOLDEN_LILYPAD));
                    world.scheduleBlockUpdate(var5, var6 + 1, var7, Block.getBlockFromName(ReferencesModBlocks.GOLDEN_LILYPAD), (int) (1200 * (float) getDelayInSeconds()));
