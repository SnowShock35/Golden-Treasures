package uk.snowshock35.goldentreasures.client;
...
import uk.snowshock35.goldentreasures.items.ItemGoldenStaff;
import uk.snowshock35.goldentreasures.references.Colors;
...
//    }
    ...
    public void handleMinerHUDCheck(){
        ...
        renderStandardTwoItemHUD(mc, player, goldenMinerStack, gunpowderStack, ReferencesConfigInfo.GoldenMiner.HUD_POSITION, 0, 0);
    }
    ...
    public void handleStaffHUDCheck() {
        ...
        renderStandardTwoItemHUD(mc, player, goldenStaffStack, placementStack, ReferencesConfigInfo.GoldenStaff.HUD_POSITION, 0, 0);
    }
